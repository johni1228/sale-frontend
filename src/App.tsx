...
const SaleDetail = lazy(()=> import('./pages/PreSale/SaleDetail'))
    ...
    <Router history={history}>
      <Layout>
        <Switch>
          ...
          <Route path='/launchpad/preSale/detail' exact component={SaleDetail} /> 
          ...
          <Route path='/launchpad/createSale/showdetail' exact component={SaleDetail} /> 
